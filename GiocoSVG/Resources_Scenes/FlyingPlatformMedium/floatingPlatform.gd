...
func _ready():
		if get_node("../../").difficulty == 2:
			get_node("CollisionPolygon2D/Polygon2D").texture = load("res://Resources_Scenes/FlyingPlatformMedium/floating_platform_two.png")
		elif get_node("../../").difficulty == 3:
			get_node("CollisionPolygon2D/Polygon2D").texture = load("res://Resources_Scenes/FlyingPlatformMedium/floating_platform_three.png")
		rng.randomize()
